...
public final class ReflectUtil {
   ...
   * log for this class
   */
	//private Logger logger = Logger.getLogger(CommonProc.class);
...
public static Object newInstance(String name) {
  ...
  /**
   * 根据属�?的名称返回对应getter方法的Method对象
   * @param argumentType setter方法的参数类�?如果为null,则返回null
   */
   ...
   * @param m 给定方法
   * @param annotationName annotation的完整类�?
   * 
   */
  ...
  /**
   * 将一个Bean转换为Map，Map�?key"是属性名称，value是属性�?.只包含当前对象的字段�?父类的字段不包括�?
   * @param bean 指定的bean
   * @param propertyNames 被转换的属�?的名称列�?如果�?code>null</code> 或长度为<code>0</code>，返回所有字�?
  ...
  /**
   * 复制�?��List中的�?��element对象到另�?��List，相当于反复调用
